...
tf.app.flags.DEFINE_string(
    'class_names', 'weights/yolov3_1.names', 'File with class names')
tf.app.flags.DEFINE_string(
    'weights_file', 'weights/yolov3_1.weights', 'Binary file with detector weights')
tf.app.flags.DEFINE_string(
    'data_format', 'NHWC', 'Data format: NCHW (gpu only) / NHWC')
tf.app.flags.DEFINE_string(
    'output_graph', 'pbmodels/yolov3_1.pb', 'Frozen tensorflow protobuf model output path')
